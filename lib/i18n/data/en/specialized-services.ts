...
export const SOFTWARE_FACTORY_PAGES: Record<string, SpecializedPage> = {
  "custom-development": {
    ...
    whatWeDo: [
      ...
      "Internal tools that replace Excel-driven processes with defined validation and traceability.",
      "Integration with SAP, enterprise databases, internal APIs, and cloud services.",
      "QA, documentation, deployment, and L2/L3 support according to the agreed scope.",
      "Iterative delivery with reviews and agreed acceptance criteria per cycle.",
    ...
    deliverables: [
      ...
      "CI/CD pipeline and observability when included in the agreed scope.",
      "Operations runbook and L2/L3 support handoff.",
      "Post go-live evolution roadmap with agreed reviews.",
      "Activity log designed to support audit review.",
    ],
    copilot:
  ...
  "internal-apps": {
    ...
    whatWeDo: [
      ...
      "Phased transition from the legacy spreadsheet with a rollback plan.",
    ],
    useCases: [
      "Finance closing app with validations and approval gates.",
      "HR change-request app over SAP HCM with audit trail.",
      "Operations incident-tracking app with visible response times.",
  ...
  "apis-microservices": {
    ...
    useCases: [
      ...
      "Webhook management for SaaS integrations.",
    ...
    deliverables: [
      ...
      "Per-API security review and secure runtime configuration.",
    ],
    copilot:
  ...
  "evolutionary-support": {
    ...
    whatWeDo: [
      "L2 and L3 support with agreed service levels and clear ownership.",
      "Continuous backlog with prioritized fixes and small enhancements.",
      "Evolutionary roadmap aligned with business priorities.",
    ...
    useCases: [
      ...
      "Feature roadmap for a portal in production.",
      "Refactoring of legacy modules with regression coverage.",
      "On-call coverage for critical platforms when included in the contracted scope.",
      "Continuous improvement of the support model itself.",
    ],
    capabilities: [
      "Agreed ticket-management practices, including ITIL when applicable",
      "Monitoring",
      "Observability",
      "Release management",
      "Change Management",
    ...
    deliverables: [
      "Support model with clear service levels and escalation.",
      "Service report on tickets, evolutions, and platform health.",
...
export const SAP_INTEGRATIONS_PAGES: Record<string, SpecializedPage> = {
  "on-premise": {
    ...
    parent: SAP_PARENT,
    intro:
      "Service scope for SAP ECC and S/4HANA across core functional modules, development, evolutions, and support with controlled changes.",
    heroBadges: ["ECC + S/4HANA", "FI · CO · SD · MM · HCM · PS · PM", "ABAP scope"],
    problem:
    ...
    deliverables: [
      ...
      "Module-level evolutions with regression controls for productive flows.",
  ...
  "sap-cloud": {
    ...
    problem:
      "The integration boundary concentrates cloud-to-on-prem flows, master data, security, and reporting risks. These areas require explicit contracts, monitoring, and ownership.",
    whatWeDo: [
  ...
  middleware: {
    ...
    problem:
      "One-off integration scripts can make changes difficult to control. Governed middleware adds monitoring, error handling, reprocessing, and traceability under an explicit operating model.",
    whatWeDo: [
    ...
    useCases: [
      ...
      "SAP ↔ payroll provider recurring cycle with audit trail.",
  ...
  successfactors: {
    ...
    parent: SAP_PARENT,
    intro:
      "Service scope for SuccessFactors Employee Central, organizational data, absences, headcount, and integration with the corporate ecosystem.",
    ...
    deliverables: [
      ...
      "Traceable report of master-data changes for audit review.",
    ],
    copilot:
  ...
  "sap-hcm": {
    ...
    parent: SAP_PARENT,
    intro:
      "Service scope for SAP HCM On-Premise: Personnel Administration, Organizational Management, Time, Absence, and integration with payroll, finance, and downstream reporting.",
    heroBadges: ["Personnel Admin · OM", "Time · Absence", "Payroll-aware integration"],
    problem:
      "HCM On-Premise can carry accumulated customizations, infotype adjustments, and country-specific logic. Changes must account for those legacy assumptions.",
    whatWeDo: [
    ...
    deliverables: [
      "HCM evolutions with regression controls for payroll cycles.",
...
export const CLOUD_DATA_PAGES: Record<string, SpecializedPage> = {
  aws: {
    ...
    problem:
      "AWS costs can grow without clear ownership and limits. The proposed design favors justified services, per-environment ownership, budgets, and explicit security boundaries.",
    whatWeDo: [
      "Static sites with S3 + CloudFront and explicit cache rules.",
  ...
  azure: {
    ...
    problem:
      "An existing Azure footprint needs clear ownership, security baselines, cost controls, and an architecture that limits uncontrolled sprawl.",
    whatWeDo: [
  ...
  databases: {
    ...
    parent: CLOUD_PARENT,
    intro:
      "Service scope for SQL Server, Oracle, PostgreSQL, MySQL, DB2, Sybase, and SAP HANA: modeling, migration, integration, reporting, and traceability.",
  ...
  reporting: {
    ...
    parent: CLOUD_PARENT,
    intro:
      "BI and executive reports designed with traceability from each agreed KPI to its authorized source.",
    heroBadges: ["Common semantic layer", "Traceable KPIs", "Audit evidence"],
    problem:
    ...
    useCases: [
      ...
      "Report bundle with source evidence for audit review.",
...
export const ENTERPRISE_AI_PAGES: Record<string, SpecializedPage> = {
  ...
  "internal-assistants": {
    ...
    problem:
      "Internal questions are often delayed by undocumented knowledge or stale wikis. A governed assistant can organize authorized content with citations and permissions.",
    whatWeDo: [
  ...
  "operational-copilots": {
    ...
    parent: AI_PARENT,
    intro:
      "Generative AI, specialized agents, and quantitative models that turn fragmented information into trusted decisions and actions.",
    heroBadges: ["Specialized agents", "Quantitative scenarios", "Human control"],
    problem:
      "An isolated answer is not enough when a team needs to understand what happened, compare scenarios, and decide the next step. Agents provide context, analysis, control, and follow-up.",
    whatWeDo: [
    ...
    useCases: [
      "Finance agent for reconciliations, scenarios, and variance analysis.",
      "Talent agent for headcount, risk, absences, and master data.",
      "Operations agent for status, incident research, and alerts.",
      "Executive agent for leadership answers, scenarios, and evidence.",
      "Audit agent for evidence retrieval and decision history.",
      "Procurement agent for supplier, risk, and spend analysis.",
    ],
    capabilities: [
      "Operational context",
      "Verifiable evidence",
    ...
    deliverables: [
      "Agent system scoped to one or more business processes.",
    ...
    copilot:
      "AI Decision Agents turn fragmented information into evidence, scenarios, and controlled actions so teams can decide with clarity.",
    primaryCta: { label: "Explore the release", href: "/copilot" },
    secondaryCta: { label: "Evaluate a use case", href: "/copilot/pilot" },
  },
};
