...
export const SOFTWARE_FACTORY_PAGES: Record<string, SpecializedPage> = {
  "custom-development": {
    ...
    parent: SF_PARENT,
    intro:
      "Enterprise applications and internal tools proposed with senior specialists selected for the project.",
    ...
    whatWeDo: [
      ...
      "QA, documentation, deployment, and L2/L3 support included in the delivery scope.",
    ...
    deliverables: [
      ...
      "CI/CD pipeline and observability included in the delivery design.",
  ...
  "evolutionary-support": {
    ...
    parent: SF_PARENT,
    intro:
      "A support model for operational continuity, traceability, and controlled evolution after go-live.",
    heroBadges: ["L2/L3 SLAs", "Evolution roadmap", "Health reviews"],
    problem:
...
export const SAP_INTEGRATIONS_PAGES: Record<string, SpecializedPage> = {
  ...
  successfactors: {
    ...
    copilot:
      "Enterprise Copilot can support HR queries over SuccessFactors with traceability and per-role permissions.",
  },
  "sap-hcm": {
    slug: "sap-hcm",
    eyebrow: "SAP & Enterprise Integration",
...
export const CLOUD_DATA_PAGES: Record<string, SpecializedPage> = {
  aws: {
    ...
    copilot:
      "Enterprise Copilot can use Lambda, API Gateway, SES, and S3 under a governed AWS architecture. Endpoints, events, and storage can support assisted queries, drafts, and approvals with traceability.",
  },
  azure: {
    slug: "azure",
    eyebrow: "Cloud & Governed Data",
  ...
  reporting: {
    ...
    copilot:
      "Enterprise Copilot can use the governed semantic layer as its primary source and reference the same agreed KPI definitions.",
  },
};
...
export const ENTERPRISE_AI_PAGES: Record<string, SpecializedPage> = {
  ...
  "operational-copilots": {
    ...
    copilot:
      "This is Enterprise Copilot: an operational copilot designed for authorized systems, permissions, validations, and traceability.",
