  ...
  "enterprise-ai": {
    ...
    sections: [
      ...
      },
      {
        ...
        description:
          "An AI layer designed to connect SAP, authorized data, and processes: Enterprise Copilot.",
        bullets: [
...
export const ENTERPRISE_AI_BLOCKS: DeepDiveBlock[] = [
  ...
  },
  {
    ...
    description:
      "An AI layer designed for SAP, databases, internal APIs, and reports with per-role permissions and validation before sensitive actions: Enterprise Copilot.",
    bullets: [
