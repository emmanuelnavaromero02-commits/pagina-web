...
export const INDUSTRY_PAGES: Record<string, SpecializedPage> = {
  finance: {
    ...
    copilot:
      "Enterprise Copilot can support finance queries, surface unreconciled entries, and prepare variance drafts with traceability and approval before any action.",
  ...
  operations: {
    ...
    copilot:
      "Enterprise Copilot can present current operational status, last successful run, and error context, then prepare actions for operator approval.",
