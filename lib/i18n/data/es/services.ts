...
export const SERVICES: ServiceCard[] = [
  {
    ...
    short: "Equipos de ingeniería dedicados.",
    description:
      "Equipos senior dedicados que construyen plataformas internas, portales y aplicaciones a medida, con responsabilidad sobre el resultado y no solo sobre las tareas.",
    icon: Code2,
    bullets: [
      "Desarrollo a medida",
...
> = {
  "software-factory": {
    ...
    title: "Fábrica de software",
    intro:
      "Construimos software empresarial que conecta operaciones, datos y decisiones. Equipos dedicados que asumen la responsabilidad del resultado, no solo del backlog.",
    icon: Code2,
    sections: [
      {
        id: "custom",
  ...
  "enterprise-ai": {
    ...
    sections: [
      ...
      },
      {
        ...
        description:
          "Una capa de IA diseñada para conectar SAP, datos autorizados y procesos: Enterprise Copilot.",
        bullets: [
...
export const ENTERPRISE_AI_BLOCKS: DeepDiveBlock[] = [
  ...
  },
  {
    ...
    description:
      "Una capa de IA diseñada para SAP, bases de datos, APIs internas y reportes, con permisos por función y validación previa a acciones sensibles: Enterprise Copilot.",
    bullets: [
      "Consultas operativas en SAP, bases de datos y APIs.",
      "Validación de inconsistencias mediante reglas de negocio.",
      "Reportes asistidos con trazabilidad.",
      "Seguridad por función heredada del sistema de origen.",
