      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 pb-24 pt-20 sm:px-6 sm:pt-24 lg:px-8 lg:pb-32 lg:pt-32">
        <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_1fr]">
          <div className="animate-fade-up">
            <Link
              href="/copilot"
              className="group inline-flex items-center gap-2 rounded-full border border-brand-200 bg-white/80 py-1.5 pl-2 pr-3 text-xs font-semibold uppercase tracking-[0.16em] text-brand-800 shadow-soft backdrop-blur transition-colors hover:bg-white"
            >
            ...
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-ink-600 sm:text-lg">
              ...
              sobre <strong className="text-ink-900">SAP</strong>,{" "}
              ...
              Convertimos procesos complejos en software operativo, trazable y
              útil.
            </p>
